...
func init() {
	register.Labels[ExampleBrightness] = "ExampleBrightness"
	register.Labels[ExampleLux] = "ExampleLux"
	register.Add(ExampleHex, ExampleRgb, 10000, func(concept interface{}) (out interface{}, err error) {
