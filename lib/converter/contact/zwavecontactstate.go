...
func init() {
	conceptToCharacteristic.Set(ZwaveContactState, func(concept interface{}) (out interface{}, err error) {
		switch state := concept.(type) {
		case bool:
			if state {
	...
	characteristicToConcept.Set(ZwaveContactState, func(in interface{}) (concept interface{}, err error) {
