...
func init() {
	conceptToCharacteristic.Set(Bar, func(concept interface{}) (out interface{}, err error) {
		switch hpa := concept.(type) {
		case int:
	...
	characteristicToConcept.Set(Bar, func(in interface{}) (concept interface{}, err error) {
		switch bar := in.(type) {
		case int:
